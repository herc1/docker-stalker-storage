...
class TvChannelsModel extends \Model\BaseStalkerModel {
    ...
    public function insertITVChannel($data){
        ...
        return $this->mysqlInstance->insert('itv', array(
                            ...
                            'tv_archive_type' => (!empty($data['tv_archive_type']) ? $data['tv_archive_type']: NULL),
                            ...
                            'mc_cmd' => ((!empty($data['tv_archive_type']) || !empty($data['allow_pvr'])) && !empty($data['mc_cmd'])? $data['mc_cmd']: ''),
                            ...
                            'languages' => (!empty($data['languages'])? $data['languages']: ''),
                            'status' => 1,
                            ...
                            'modified' => 'NOW()',
                            'added' => 'NOW()',
                            'tv_archive_duration' => (!empty($data['tv_archive_type']) && !empty($data['tv_archive_duration'])? intval($data['tv_archive_duration']): 0)
                        ))->insert_id();
    }
    ...
    public function changeITVGenre($id, $tv_genre_id){
        return $this->mysqlInstance->update('itv', array('tv_genre_id' => $tv_genre_id, 'modified' => 'NOW()'), array('id' => $id))->total_rows();
    }

    public function changeITVLanguages($id, $languages){
        return $this->mysqlInstance->update('itv', array('languages' => $languages, 'modified' => 'NOW()'), array('id' => $id))->total_rows();
    }
